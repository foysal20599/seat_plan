                        ...
                        <div class="card">
                            ...
                            <div class="card-header pt-4 pb-4 text-center bg-primary">
                                <div class="row">
                                    <div class="col-md-3">
                                        <a href="#">
                                            <span><img src="assets/images/stamford.png" alt="" height="50"></span>
                                        </a>
                                    </div>
                                    <div class="col-md-7">
                                        <ul>
                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('teacher.info') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" id="fullname" placeholder="Name"  name="name" value="{{ old('name') }}"  autofocus autocomplete="name">
                                        @error('name')  
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('phone') is-invalid @enderror" type="number" id="email"  name="phone" value="{{ old('phone') }}"  placeholder="Phone">
                                        @error('phone')  
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('user_name') is-invalid @enderror" type="text" id="" name="user_name" value="{{ old('user_name') }}"  placeholder="Username">
                                        @error('user_name')  
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('f_id') is-invalid @enderror" type="text" id="facultyID"  maxlength="11" name="f_id" value="{{ old('f_id') }}"   placeholder="Faculty id">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('desination') is-invalid @enderror" type="text" id="d" name="desination" value="{{ old('desination') }}"  placeholder="Desination">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="password" class="form-control @error('password_confirmation') is-invalid @enderror"  name="password_confirmation"  autocomplete="new-password" placeholder="Confirm Password">
                                            <div class="input-group-text" data-password="false">
                                                <span class="password-eye"></span>
                                            </div>
                                        </div>
